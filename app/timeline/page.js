export default function Timeline() {
  const events = [
    ...
    { date:'Fall 2025', title:'Implementation Push', desc:'Biweekly meetings established (1st/3rd Wednesdays, 1–3 PM). CourseDog integration discovery. Microsoft 365 Forms deployed. Three pillars framework developed. Department chair meeting presentation (alongside Follett). Library OER integration in curriculum review.', status:'past' },
    ...
    { date:'November 2025', title:'Data Deep Dive', desc:'EIS/Informer data pulls for ZTC baseline. Identified ~18% reporting rate. Discovered Savings Plus interaction. Bookstore data alignment questions identified. Faculty survey yielded limited responses.', status:'past' },
