      ...
      <div className="page-container">
        ...
        <section className="section">
          ...
          <ul>
            ...
            <li><strong>Governance and process considerations</strong> — Syllabus review for OER tracking intersects with established evaluation processes and contractual protocols. Navigating these structures requires cross-functional collaboration.</li>
            ...
            <li><strong>Undefined organizational placement</strong> — The "OER" function exists on the org chart but lacks clear definition, authority, and staffing. The team advocates for OER as its own entity alongside the Library and Distance Education, with dedicated staffing and direct reporting to instructional leadership.</li>
        ...
        <section className="section">
          ...
          <ul>
            <li><strong>Structured deadlines and check-ins</strong> — Convenings created external milestones and peer accountability that kept the project moving when internal momentum flagged.</li>
            <li><strong>Institutional legitimacy</strong> — Participation in a statewide RP Group academy gave middle leaders the credibility and standing to advance cross-institutional initiatives that would otherwise lack formal sponsorship. "We're part of an RP Group academy" opened doors that "we have an idea" did not.</li>
            <li><strong>Frameworks for navigating complexity</strong> — Tools like Monroe's Motivated Sequence, stakeholder mapping, and systems change frameworks gave the team structured approaches to what would otherwise be ad hoc relationship management.</li>
        ...
        <section className="section">
          ...
          <div className="momentum-grid">
            ...
            <div className="momentum-item"><div className="bar moving" /><div className="content"><h4>Establish Departmental OER Leads</h4><p>Recruit a faculty OER lead within each department to serve as the primary liaison between the OER office and their discipline. These leads would form the core of a working group that bridges central coordination with department-level implementation — ensuring the initiative has reach without requiring a large central staff.</p></div></div>
            <div className="momentum-item"><div className="bar moving" /><div className="content"><h4>Address OER Accessibility</h4><p>Partner with the campus High Tech Center to research and document existing accessibility tools within major OER platforms — LibreTexts, OpenStax, and library database resources. Ensuring OER materials meet accessibility standards is both a compliance requirement and an equity imperative. This work should be integrated into adoption guidance so faculty receive accessibility support alongside content support.</p></div></div>
